<li class="<?php echo (isset($spanClass)) ? $spanClass : 'span8'; ?>">
    ...
    <div class="caption">
        <h5>
            <a href="<?php echo $this->createUrl('/user/profile/', array('id' => $list->subject->id))?>"><?php echo $list->subject->displayname; ?></a>
            <i class="icon-chevron-right"></i>
            <a href="<?php echo $this->createUrl('/user/profile/', array('id' => $list->object->id))?>"><?php echo $list->object->displayname; ?></a>
        </h5>
        <p><?php echo $list->body; ?></p>

        <p>
            <?php if ($list->comment_count > 0): ?>
                <a class="comment-links" href="#">Comments</a> <span class="badge <?php echo ($list->comment_count > 0) ? 'badge-inverse' : ''; ?>"><?php echo number_format($list->comment_count); ?></span> | 
            <?php else: ?>
